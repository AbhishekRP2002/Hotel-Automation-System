...
Label(sroot,text="Group 2",font='Timesnewroman 40 ',bg='white',fg='grey').place(x=535,y=180)
...
def mainroot():
	...
	#-----------------------------------------------------------------
		nl = Label(b_frame,text='Made by Group 2',fg='black',bg='gray91',font='msserif 8')
	...
	def staff():
		...
		Label(emp1inf,text="Mr. Group 2 Khare",bg='white',fg="Grey",font='msserif 10').place(x=60,y=37)
